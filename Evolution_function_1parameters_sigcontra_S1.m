function[x]=Evolution_function_1parameters_sigcontra_S1(x, P, u, in) %input: current impression, bias coefficient, new evidence, additional info(empty)

% Check if u(3) is 3, 4, or 5
    if u(3) == 1|| u(3) == 2 || u(3) == 3 || u(3) == 4
